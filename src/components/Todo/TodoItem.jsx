...
const TodoItem = ({
  ...
  return (
    <div
      className={`group mb-3 flex items-center gap-3 rounded-md border-2 p-2 pl-3 transition-all ${
    ...
    >
      ...
      {!todo.completed && (
        <>
          <button
            className={`btn-accent btn-sm btn flex w-[46px] flex-nowrap justify-start overflow-hidden text-sm transition-all hover:w-[120px] ${
              timerStarted ? "w-[120px]" : ""
            }`}
            onClick={() => toggleTimer()}
          >
            {timerStarted ? (
          ...
          <button
            className="btn-secondary btn-sm btn text-sm"
