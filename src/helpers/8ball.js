...
function get8BallResponse() {
  ...
  const yesResponses = [
    ...
    "Your mom would say yes to that",
  ];
  const maybeResponses = [
    "Maybe",
    "I'd say you need some self reflection first",
    "I mean it could happen but what's the point?",
  ];
  const noResponses = [
    "No",
    "Absolutley not",
    "I've never wanted to say no more to anything in my life",
...
export default get8BallResponse;
